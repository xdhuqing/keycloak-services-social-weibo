...
public class WeiBoIdentityProviderFactory extends AbstractIdentityProviderFactory<WeiBoIdentityProvider>
    ...
    @Override
    public WeiBoIdentityProvider create(KeycloakSession session, IdentityProviderModel model) {
        return new WeiBoIdentityProvider(session, new OAuth2IdentityProviderConfig(model));
    }
